      ...
      <section className="py-10 bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {[
              { icon: '📋', title: 'GST Registered Business', detail: 'GST No: 23DNCPG4775E1Z7 — Har service pe proper GST invoice milti hai.' },
              { icon: '🏛️', title: 'MSME / Udyam Registered', detail: 'Udyam No: UDYAM-MP-10-0042011 — Government recognized small business.' },
              { icon: '✅', title: 'Verified Technicians', detail: 'Sab technicians background-verified aur professionally trained hain.' },
              { icon: '🛡️', title: '30-Day Service Warranty', detail: 'Har repair pe 30-day warranty — same problem dobara aaye toh free fix.' },
            ].map((item) => (
              <div key={item.title} className="flex gap-4 p-5 bg-gray-50 border border-gray-200 rounded-xl">
