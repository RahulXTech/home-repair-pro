        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <Link href="/" className="inline-block mb-3">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden shadow-2xl ring-2 ring-white/30">
                <Image
                  src="/images/logo.jpg"
                  alt="HomeRepairPro"
                  width={96}
            ...
            <p className="text-xs leading-5 text-white/90 mb-3">
            ...
            <div className="flex gap-3">
              {/* Facebook */}
              <a href="#" aria-label="Follow us on Facebook" className="w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-transform" style={{ backgroundColor: '#1877F2' }}>
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="#" aria-label="Follow us on Instagram" className="w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-transform" style={{ background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)' }}>
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              {/* YouTube */}
              <a href="#" aria-label="Follow us on YouTube" className="w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-transform" style={{ backgroundColor: '#FF0000' }}>
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M23.495 6.205a3.007 3.007 0 00-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 00.527 6.205a31.247 31.247 0 00-.522 5.805 31.247 31.247 0 00.522 5.783 3.007 3.007 0 002.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 002.088-2.088 31.247 31.247 0 00.5-5.783 31.247 31.247 0 00-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/>
                </svg>
              </a>
              {/* LinkedIn */}
              <a href="#" aria-label="Follow us on LinkedIn" className="w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-transform" style={{ backgroundColor: '#0A66C2' }}>
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <div>
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex items-start gap-2">
                <span className="mt-0.5 shrink-0 w-7 h-7 rounded-full bg-white/20 flex items-center justify-center">
                ...
                <div>
                  <p className="font-semibold text-white leading-tight">HomeRepairPro</p>
                  <p className="text-white/75 leading-tight">Madhya Pradesh, India</p>
                </div>
              </div>

              {/* Phone */}
              <a href="tel:+918889539174" className="flex items-center gap-2 group">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/90 break-all">bhopalservice998@gmail.com</span>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 active:bg-green-600 text-white text-xs font-semibold px-3 py-2 rounded-full transition-colors shadow-md"
              >
